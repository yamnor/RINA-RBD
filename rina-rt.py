...
def main():
  ...
  st.title("RIN Analyzer for the Receptor Binding Domain of SARS-CoV-2 Spike Protein")
  ...
  node['chain'] = ['ACE2' for n in range(596)] + ['RBD' for n in range(194)]
  node['resid'] = [n + 1 for n in range(596)] + [n + 1 for n in range(194)]
